...
# Multi-tenant platform schemas (Phase 1)
from schemas_platform import (  # noqa: E402,F401
    DocumentTypeCreate,
    DocumentTypeRead,
    DocumentTypeUpdate,
    ...
    FlowStepRead,
    FlowStepUpdate,
    GeneratedDocumentOrgFieldsUpdate,
    OrgDocumentTypeCreate,
