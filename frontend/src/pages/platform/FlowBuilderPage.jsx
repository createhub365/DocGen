    ...
    >
      <Form
        ...
        onFinish={(values) => {
          ...
          const isTradeLinked = !isAuto && !!values.is_trade_linked_duties
      ...
      >
        ...
        >
          <Checkbox
            onChange={(e) => {
              if (e.target.checked) {
                form.setFieldValue('is_trade_linked_duties', false)
              }
            }}
          >
        ...
        {!isAutoGenerated ? (
          <Form.Item
            name="is_trade_linked_duties"
            valuePropName="checked"
            extra="In Generate, shows a trade selector that auto-fills this duties text (still editable). Uses the organization Trade Bank."
          >
            <Checkbox
              onChange={(e) => {
                if (e.target.checked) {
